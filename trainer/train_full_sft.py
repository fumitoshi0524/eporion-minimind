...
def main():
    parser = argparse.ArgumentParser(description="Eiporion Full SFT")
    parser.add_argument(
        "--save_dir",
        type=str,
        default="out",
    ...
    if args.use_swanlab:
        ...
        swanlab.init(
            ...
            name=f"Eiporion-FullSFT-Epoch-{args.epochs}-BatchSize-{args.batch_size}-LearningRate-{args.learning_rate}",
